...
public class Delve {
    ...
    @JsonProperty("WeightList")
    public void setWeightList(WeightList value) { this.weightList = value; }
    ...
    public String[] getModFossilItem() { return modFossilItem; }
    @JsonProperty("mod_fossil_item")
    public void setModFossilItem(String[] value) { this.modFossilItem = value; }
}
