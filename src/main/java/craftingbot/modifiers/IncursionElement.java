...
public class IncursionElement {
    private String id;
    private IncursionName name;
    private String code;
    ...
    @JsonProperty("Name")
    public IncursionName getName() { return name; }
    @JsonProperty("Name")
    public void setName(IncursionName value) { this.name = value; }
